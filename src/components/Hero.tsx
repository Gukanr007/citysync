        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          <div className="mb-6">
            <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
              <Navigation size={16} />
              <span className="text-sm font-medium">Smart Civic Engagement Platform</span>
            </div>
          </div>
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto leading-relaxed">
            Transform the way you interact with your city. Report issues, engage with your community, 
            and stay informed about local developments - all in one powerful platform.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-white text-white hover:bg-white hover:text-blue-800 text-lg px-8 py-3 shadow-lg transition-all duration-200 transform hover:scale-105"
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-blue-100 text-sm">Report potholes, streetlight issues, and more with GPS precision</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-blue-100 text-sm">Connect with neighbors and participate in local decisions</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white hover:bg-white/20 transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-blue-100 text-sm">Encrypted communication with local authorities</p>
              </CardContent>
            </Card>
          </div>
        </div>
